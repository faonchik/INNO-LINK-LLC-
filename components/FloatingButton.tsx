  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      <div className="relative flex flex-col items-center">
        {/* Кнопки соц. сетей */}
        <div className={`absolute bottom-full mb-4 transition-all duration-300 transform ${isOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10 pointer-events-none'}`}>
          <div className="flex flex-col gap-4 items-center">
            {/* Telegram */}
            <a
              href="https://t.me/INNO_LINK07"
              className="flex items-center group relative transform transition-transform duration-200 hover:scale-110"
              target="_blank"
        ...
        <button
          ...
          className="w-[60px] h-[60px] bg-[#0088cc] rounded-full flex items-center justify-center shadow-lg hover:bg-[#0099dd] transition-all duration-300 transform hover:scale-105 focus:outline-none"
        >
          {!isOpen ? (
            ...
            <svg className="w-4 h-4 transform rotate-0 transition-transform duration-300" viewBox="0 0 23 23" xmlns="http://www.w3.org/2000/svg">
